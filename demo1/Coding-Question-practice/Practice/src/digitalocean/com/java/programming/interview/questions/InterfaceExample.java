...
Abstract methods must be implemented in a class.
Default methods allow adding new functionality to an interface without breaking existing code.
Static methods belong to the interface and cannot be overridden.
Private methods help reduce code duplication inside the interface (Java 9+).
 */
